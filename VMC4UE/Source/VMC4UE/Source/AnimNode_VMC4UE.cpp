//#include "MySandbox.h"
#include "../Include/AnimNode_VMC4UE.h"
...
// ----------------------------------------------------------------------------
void FAnimNode_VMC4UE::Initialize_AnyThread(const FAnimationInitializeContext &Context)
{
...
void FAnimNode_VMC4UE::GatherDebugData(FNodeDebugData &DebugData)
{
...
void FAnimNode_VMC4UE::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext &Output, TArray<FBoneTransform> &OutBoneTransforms)
{
...
bool FAnimNode_VMC4UE::IsValidToEvaluate(const USkeleton *Skeleton, const FBoneContainer &RequiredBones)
{
...
void FAnimNode_VMC4UE::InitializeBoneReferences(const FBoneContainer &RequiredBones)
{
